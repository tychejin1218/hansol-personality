            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>지역국 수정</h4>
                            <form:form method="post" action="../region/update" modelAttribute="region">
                                <form:input type="hidden" path="id"/>
                                <form:input type="hidden" path="hq" value="${hqId}"/>
                                <div class="form-group">
                                    <label>지역국 이름</label>
                                    <form:input type="text" class="form-control" path="name" placeholder="지역국 이름 입력" autofocus="autofocus"/>
                                    <form:errors class="text-danger" path="name" />
                                </div>
                                
                                <div class="text-right">
                                    <a href="../region/index?hqId=${hqId}" class="btn btn-secondary float-left">목록</a>
