                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="/resources/static/images/orientations/ot_8.png" alt="OT"
                                    style="width:90%" />
                            </div>
                            <hr />
                            <div>
                                <a class="btn btn-secondary" href="../ot7">이전</a>
                                <form:form method="post" action="../test" class="float-right form-inline">
                                    <button type="button" class="btn btn-danger float-right text-white"
                                        onclick="confirmEndOrientation(this)">검사 시작</button>
                                </form:form>
                            </div>
                        </div>
                    </div>
