                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img src="/resources/static/images/orientations/ot_4.png" alt="OT"
                                    style="width:100%" />
                            </div>
                            <hr />
                            <div>
                                <a class="btn btn-secondary" href="../ot3">이전</a>
                                <a class="btn btn-primary float-right text-white" href="../ot5">다음</a>
                            </div>
                        </div>
                    </div>
                </div>
