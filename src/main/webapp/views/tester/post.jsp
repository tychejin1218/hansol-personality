            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>지원자 등록</h4>
                            <form:form method="post" action="../tester/post" modelAttribute="tester" autocomplete="off">
                                ...
                                <sec:authorize access="hasRole('ROLE_ADMIN')">
                                    <div class="form-group form-check">
                                        <form:checkbox path="isRetry" class="form-check-input" id="exampleCheck1"></form:checkbox>
                                        <label class="form-check-label" for="exampleCheck1">재응시</label>
                                      </div>
                                </sec:authorize>
                                ...
                                <div class="text-right">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="submit(this)">등록</button>
                                </div>
                            </form:form>
                        </div>
                    </div>
