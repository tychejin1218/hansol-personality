            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>본부 수정</h4>
                            <form:form method="post" action="../hq/update" modelAttribute="hq">
                            <form:input type="hidden" path="id"/>
                                <div class="form-group">
                                    <label>본부명</label>
                                    <form:input type="text" class="form-control" path="name" placeholder="본부 이름 입력" autofocus="autofocus"/>
                                    <form:errors class="text-danger" path="name" />
                                </div>
                                
                                <div class="text-right">
                                    <a href="../hq/index" class="btn btn-secondary float-left">목록</a>
