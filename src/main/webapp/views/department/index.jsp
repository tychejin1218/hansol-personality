                        ...
                        <div class="card-body">
                            <h4>부서 리스트</h1>
                                    ...
                                    <tbody>
                                        <c:forEach var="department" items="${list}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>
                                                    <form:form method="post" action="../department/delete?id=${department.id}&regionId=${regionId}">
                                                        <a href="../department/update?id=${department.id}"
                                                            class="btn btn-sm btn-success">수정</a>
                                                        <button type="button" class="btn btn-sm btn-danger"
                                                            onclick="deleteDepartmentConfirm(this)">삭제</button>
                                                    </form:form>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                ...
                                <div class="text-right">
                                    <a class="btn btn-secondary float-left" href="../region/index?hqId=${hqId}">지역국 목록</a>
                                    <a href="../department/post?regionId=${regionId}" class="btn btn-primary">추가</a>
                                </div>
                        </div>
                    </div>
                </div>
