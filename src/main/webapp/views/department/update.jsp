            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>부서 수정</h4>
                            <form:form method="post" action="../department/update" modelAttribute="department">
                                <form:input type="hidden" path="id"/>
                                <form:input type="hidden" path="region"/>
                                <div class="form-group">
                                    <label>부서 이름</label>
                                    <form:input type="text" class="form-control" path="name" placeholder="부서 이름 입력" autofocus="autofocus"/>
                                    <form:errors class="text-danger" path="name" />
                                </div>
                                
                                <div class="text-right">
                                    <a href="../department/index?regionId=${regionId}" class="btn btn-secondary float-left">목록</a>
