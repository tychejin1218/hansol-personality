            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>그룹 수정</h4>
                            <form:form method="post" action="/group/update" modelAttribute="group">
                                <form:input type="hidden" path="id" />
                                <div class="form-group">
                                    <label>채용 그룹명</label>
                                    <form:input type="text" class="form-control" path="name" placeholder="채용 그룹 이름 입력" autofocus="autofocus"/>
                                    <form:errors class="text-danger" path="name" />
                                </div>
                                
                                <div class="text-right">
                                    <a href="../group/index" class="btn btn-secondary float-left">목록</a>
