                ...
                <div class="container-fluid">
                    <div>
                        <a class="logo" style="margin-top:10px;margin-bottom:10px">
                            <img src="/resources/static/images/toplogo.png" alt="" style="width:116px!important;height:48px!important">
                        </a>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>비밀번호 변경</h4>
                            <form:form method="post" action="../admin/resetPassword" modelAttribute="resetPasswordViewModel">
                                <div class="form-group">
                                    <label>현재 비밀번호<span class="text-danger">*</span></label>
                                    <input type="password" class="form-control" name="currentPassword" path="currentPassword" placeholder="현재 비밀번호 입력" autofocus/>
                                    <form:errors class="text-danger" path="currentPassword" />
                                </div>

                                <div class="form-group">
                                    <label>새 비밀번호<span class="text-danger">* (영문자, 숫자, 특수문자 포함 8자리 이상)</span></label>
                                    <input type="password" class="form-control" name="newPassword" path="newPassword" placeholder="새 비밀번호 입력" autofocus/>
                                    <form:errors class="text-danger" path="newPassword" />
                                </div>

                                <div class="form-group">
                                    <label>새 비밀번호 확인<span class="text-danger">*</span></label>
                                    <input type="password" class="form-control" name="newPasswordConfirm" path="newPasswordConfirm" placeholder="새 비밀번호 확인 입력" autofocus/>
                                    <form:errors class="text-danger" path="newPasswordConfirm" />
                                </div>
