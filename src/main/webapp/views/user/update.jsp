            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4>관리자 수정</h4>
                            <form:form method="post" action="../user/update" modelAttribute="admin">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="hq-list" name="hq">
                                        <c:forEach var="hq" items="${hqs}">
                                            <c:if test="${hq.id == admin.department.region.hq.id}">
                                                <option value="${hq.id}" selected>${hq.name}</option>
                                            </c:if>
                                            <c:if test="${hq.id != admin.department.region.hq.id}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="region-list" name="region">
                                        <c:forEach var="region" items="${regions}">
                                            <c:if test="${region.id == admin.department.region.id}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="department-list" name="department">
                                        <c:forEach var="department" items="${departments}">
                                            <c:if test="${department.id == admin.department.id}">
